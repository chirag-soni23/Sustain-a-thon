        ...
        <table className="min-w-full text-left text-gray-100 border-collapse">
          <thead className="sticky top-0 bg-gray-700/90 z-10">
            <tr>
              ...
              <th className="px-4 py-2 border-b border-gray-600">Lower Bound</th>
              <th className="px-4 py-2 border-b border-gray-600">Upper Bound</th>
            </tr>
          </thead>
          <tbody>
            {Object.entries(data.Forecast).map(([date, value]) => (
              <tr key={date} className="hover:bg-gray-700/50 transition-colors">
                ...
                <td className="px-4 py-2 border-b border-gray-600 font-semibold">{value.forecast}</td>
                <td className="px-4 py-2 border-b border-gray-600 text-green-400">{value.lower_bound}</td>
                <td className="px-4 py-2 border-b border-gray-600 text-red-400">{value.upper_bound}</td>
              </tr>
            ))}
          </tbody>
        </table>
